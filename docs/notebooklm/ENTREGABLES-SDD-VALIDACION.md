...
- **Agente Auditor:** Si **auditorScore < 85**, el Manager devuelve el documento a agentes especializados con `critical_gaps` estructurados; si **>= 85** se cede al usuario. El umbral operativo es **85%** (no 95%).
