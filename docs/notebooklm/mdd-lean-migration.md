# MDD lean pipeline — nota de migración (Oleada 0)

Rama de trabajo: `feat/mdd-lean-pipeline-model-tiers`  
Base: `origin/master` (el plan referencia `main`; en este repo la rama principal es `master`).

Documento de referencia para oleadas 1–4. Sin cambios de producto en Oleada 0.
...
- Modelo chat (ligero) — hint: Haiku; conversación Workshop
- Modelo grafo (medio) — hint: Sonnet; generadores §1/§6/§7, Quality Gate, entregables
- Modelo arquitecto (potente) — hint: Opus; §2–§5 SQL/API
