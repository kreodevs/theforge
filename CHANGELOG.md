...
- **Tasks con coordenadas exactas / diffs en repo** (`docs/implementation-scope.md` §6): fase posterior; YAGNI hasta que el agente implementador consuma patches acotados.
