...
- **`format-document-markdown.ts`:** `/formatear` en Workshop (Fase 0 DBGA, BRD, etc.) — `repairPastedMarkdown` + tablas + Mermaid (`normalizeMermaidInDocument` saca viñetas/prosa pegada dentro de fences).
