...
- **`theforge-doc-stamp.ts`:** peel/reattach del stamp `<!-- theforge-doc:created|updated -->` + blockquote 📅; `peelDocumentBodyForPersist` y `repairInlineHorizontalRuleSectionBreaks` limpian stamps pegados/corruptos antes de persistir.
