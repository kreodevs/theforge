...
- [X] **Circuit Breaker** — protege frente a degradación de dependencias externas (DEP-001 a DEP-011).
...
| Evento de negocio | Hecho estructurado e inmutable emitido por una aplicación; representable como mensaje o rich card sin convertirse en la fuente oficial del estado | D-025, D-128 |
| Eliminación lógica | Ocultamiento operativo de contenido con preservación de autoría, evidencia e historial auditado | D-023 |
| Membresía técnica de agente | Autorización explícita que permite a un agente habilitado para la aplicación o contexto participar en un tema manual privado no E2EE sin ampliar la audiencia del tema | D-106 |
...
<!-- paso0-risks-remediation -->

| ID | Riesgo | Mitigación | D-IDs |
|---|---|---|---|
| R-001 | La amplitud del MVP deriva en una réplica generalista o en verticales incompletas | Genérica | — |
| R-003 | Se pierden, duplican, desordenan o publican antes de tiempo eventos de negocio; una caída de Chat llega a bloquear al productor | Genérica | — |
| R-004 | Un cambio incompatible u ownership difuso en SSO, eventos, Tasks, Hub, medios o MCP rompe consumidores o deja fallos sin responsable | Genérica | — |
| R-005 | Identidades inestables, membresías mal resueltas o desactivaciones dejan acceso indebido, pierden autoría o crean contextos sin administrador | Genérica; Tasks es especialización OBP | — |
| R-006 | Un adjunto malicioso, sospechoso o no analizable queda visible, o la capacidad de medios impide compartir contenido de forma segura | Genérica | — |
| R-007 | La implementación E2EE, la recuperación corporativa o un procesador imprescindible amplían acceso, pierden llaves o degradan disponibilidad | Genérica | — |
| R-009 | Retención, purga, restauración, legal hold o exportación se aplican con periodos o alcances incorrectos, y Chat se interpreta como expediente permanente | Genérica; D-120 introduce excepción OBP | — |
| R-010 | Administración, soporte o `break-glass` se convierten en lectura ordinaria o recuperación E2EE sin aprobación y alcance válidos | Genérica | — |
| R-011 | El agente MCP hereda permisos del usuario, accede a temas no autorizados, filtra datos o amplifica una sesión E2EE o `break-glass` | Genérica; el agente de campañas es la especialización OBP | — |
| R-012 | Analítica u observabilidad reconstruyen contenido o comportamiento identificable de temas privados o E2EE | Genérica | — |
| R-013 | El cliente móvil únicamente en línea pierde utilidad con conectividad inestable o muestra estado autorizado obsoleto al reconectar | Genérica | — |
| R-014 | Operar componentes propios o adoptados supera la capacidad normal de parches, respaldos, resiliencia, diagnóstico y atención | Genérica | — |
| R-015 | Licencias, términos, límites, coste, soporte u obsolescencia de APIs y componentes externos invalidan GIF, antimalware, búsqueda, E2EE o exportación | Genérica | — |
| R-016 | Hub, correo o futuros canales de aviso fallan, filtran datos o generan ruido sin respetar privacidad y no leídos | Genérica | — |
| R-017 | El coste de historial, archivos, cuarentena, procesamiento, observabilidad o invocaciones MCP crece sin señales para gobernarlo | Genérica; incluye excepción OBP activa | — |
| R-018 | Los usuarios mantienen conversaciones operativas fuera del contexto y no se reduce la dependencia de Teams o Google | Genérica; se observa primero en OBP | — |
| R-019 | La migración de campañas elegibles pierde relaciones, autoría, permisos, archivos o cambios del delta, o abre dos superficies de escritura | Específica OBP | — |
...
<!-- paso0-decisions-remediation -->

| D-ID | Regla (catálogo Paso 0) |
|---|---|
| D-007 | Reducir la dependencia de Teams + Make para campañas sin que una falla de Chat bloquee o revierta la operación de OBP |
| D-008 | Origen de eventos |
| D-021 | Genérica |
| D-049 | Catálogo GIF con abstracción desacoplada |
| D-062 | Registro de dispositivos para push y preferencias avanzadas de notificación |
| D-063 | Webhooks salientes |
| D-064 | Identidades externas y guest, sin habilitar invitaciones |
| D-065 | Invitaciones B2B/B2C |
| D-090 | Política E2EE inicial de OBP sin cifrado por defecto |
| D-094 | Almacenamiento dedicado |
| D-096 | Búsqueda central completa e indexación confiable sobre E2EE |
| D-101 | Puntos de integración con DLP corporativo |
| D-102 | Inspección DLP avanzada y clasificación automática |
| D-110 | Analítica identificable por tema privado o E2EE |
| D-114 | SLA contractual y centro de soporte permanente |
| D-116 | Documentación de contratos |
| D-117 | Catálogo o comité central de contratos |
| D-146 | Secuencia de entrega |
...
| POST | `/mcp` | Transporte JSON-RPC MCP (invocación de herramientas) | credencial agente + doble autorización | — |
| GET | `/mcp` | Descubrimiento de capacidades MCP | credencial agente habilitada | — |
| **Cifrado** ||||
...
<!-- paso0-api-remediation -->

Endpoint de transporte **JSON-RPC** para agentes externos registrados (—).
...
| D-084 | §1, §6 | ✓ |
| D-085 | §1, §3, §5 | ✓ |
| D-086 | §1, §2, §3, §4, §5, §6, §7, §8, §8+ | ✓ |
| D-087 | §2, §7, §8, §8+ | ✓ |
| D-088 | §1, §7, §8, §8+ | ✓ |
| D-089 | §1, §2, §3, §4, §5, §6 | ✓ |
| D-090 | §1 | ✓ |
| D-091 | §2, §3, §4, §5, §6, §7 | ✓ |
| D-092 | §1, §2, §3, §4, §5, §6, §7, §8, §8+ | ✓ |
| D-093 | §0, §2, §3, §4, §6, §7, §8, §8+ | ✓ |
| D-094 | §1 | ✓ |
| D-095 | §0, §1, §3 | ✓ |
| D-096 | §1 | ✓ |
| D-097 | §1 | ✓ |
...
|---|---|---|
| D-002, D-004 | Núcleo contextual multiaplicación `application + contextType + contextId` | ✓ |
| D-003 | Identidad corporativa mediante SSO Integral, sin credenciales de usuario propias | ✓ |
| D-133 | Alta de aplicación consumidora desde consola por administrador global | ✓ |
| D-134 | Registro de aplicación con responsable funcional, política de administradores, retención, política E2EE y credenciales | ✓ |
| D-135 | Credenciales propias de aplicación, distintas de la identidad de personas | ✓ |
| D-145 | Activación modular de capacidades por aplicación | ✓ |
| D-123 | Componente embebido contextual y no invasivo | ✓ |
| D-028 | Aislamiento de la experiencia embebida a la aplicación actual | ✓ |
| D-044 | Aplicación central multiaplicación sin bypass de aislamiento | ✓ |
| D-078, D-162 | Clientes web y móvil separados con dominio y contratos compartidos | ✓ |
| D-087 | Operación móvil únicamente en línea con estado desconectado | ✓ |
| D-093, D-162 | Invariante de aislamiento: `application_id`, autorización server-side y segunda barrera a nivel de datos | ✓ |
| D-002, D-011 | Contextos genéricos y tema `General` predeterminado | ✓ |
| D-080 | Temas administrados por aplicación | ✓ |
| D-014 | Temas manuales creados sólo por administradores contextuales | ✓ |
| D-045, D-081 | Privacidad de tema manual, fija tras el primer mensaje | ✓ |
| D-016, D-045 | Membresía contextual y membresía de tema privado | ✓ |
| D-136 | Archivado del contexto ante eliminación del objeto de negocio; nunca borrado | ✓ |
| D-137 | `displayName` actualizable, `externalId` inmutable | ✓ |
| D-084 | Roles administrador contextual, miembro y solo lectura | ✓ |
| D-155 | Definición de facultades del rol miembro | ✓ |
| D-156 | Un miembro nunca añade participantes | ✓ |
| D-082 | Scopes administrativos separados, sin lectura automática | ✓ |
| D-149 | Separación de scopes del sistema, independiente de la estructura organizacional | ✓ |
| D-151 | Mapeo de scopes: gerencia como administrador global y Seguridad/Compliance | ✓ |
| D-083 | Acceso `break-glass` gobernado | ✓ |
| D-150 | `break-glass`: solicitud desde coordinación y desarrollo, aprobación desde gerencia | ✓ |
| D-085 | Gobierno de administradores y recuperación de contextos huérfanos | ✓ |
| D-047 | Subconversaciones configurables | ✓ |
| D-027, D-060 | Archivado manual y automático configurable | ✓ |
| D-006 | Cronología unificada de actividad humana y automática | ✓ |
| D-124 | Mensajería base: texto, emojis, reacciones, menciones individuales y respuestas citadas | ✓ |
| D-023, D-024 | Edición y eliminación lógica auditadas | ✓ |
| D-025 | Eventos de negocio inmutables desde Chat | ✓ |
| D-125 | Adjuntos multimedia con previsualización básica; video como adjunto | ✓ |
| D-086 | Seguridad obligatoria de adjuntos | ✓ |
| D-049 | Catálogo GIF con abstracción desacoplada | ✓ |
| D-053 | Mensajes programados con revalidación de permisos | ✓ |
| D-054 | Mensajes fijados | ✓ |
| D-055 | Menciones masivas y por etiqueta | ✓ |
| D-158 | Etiquetas de mención definidas dentro de Workspace Chat | ✓ |
| D-126 | Realtime de mensajes y actividad | ✓ |
| D-080, D-115 | Contrato genérico de eventos versionado, autorizado e idempotente | ✓ |
| D-141 | Invariante genérico de confiabilidad del productor | ✓ |
| D-142 | Exigibilidad del invariante sólo por contrato | ✓ |
| D-008, D-009 | Emisión post-persistencia y no bloqueo del negocio | ✓ |
| D-057 | Rich cards y acciones gobernadas | ✓ |
| D-030 | Contadores globales, por contexto y por tema, con indicador de mención | ✓ |
| D-030, D-061 | Hub de Notificaciones y correo | ✓ |
| D-031 | Búsqueda por aplicación | ✓ |
| D-157 | Búsqueda en cliente central por aplicación seleccionada | ✓ |
| D-092 | Búsqueda local limitada en contextos E2EE | ✓ |
| D-115 | Gobierno distribuido de contratos | ✓ |
| D-089, D-132 | E2EE configurable por aplicación y contexto | ✓ |
| D-131 | Fundamento de E2EE: confidencialidad comercial, sin obligación externa | ✓ |
| D-091, D-147 | Recuperación corporativa E2EE — decisión condicionada | ✓ |
| D-092 | Procesadores imprescindibles con alcance mínimo | ✓ |
| D-090 | Política E2EE inicial de OBP sin cifrado por defecto | ✓ |
| D-098 | Retención por cinco capas | ✓ |
| D-099, D-153 | Legal hold y exportación puntual gobernados | ✓ |
| D-099 | Residencia en la región aprobada | ✓ |
| D-139 | Herencia del marco corporativo de datos personales | ✓ |
| D-103 | Invocación MCP explícita y de solo lectura | ✓ |
| D-106 | Agente en tema manual privado no E2EE con membresía técnica | ✓ |
| D-104 | Retención técnica del agente | ✓ |
| D-103 | Agente externo de campañas como primer caso | ✓ |
| D-058 | Panel de administración | ✓ |
| D-161 | Analítica general agregada de uso y operación | ✓ |
| D-109 | Analítica agregada sin contenido en temas privados y E2EE | ✓ |
| D-111 | Observabilidad básica y atención en operación normal | ✓ |
| D-119, D-120, D-121 | Migración de campañas elegibles, historial completo, retención activa y corte | ✓ |
| D-154 | Autoridad de exclusión: gerencia del equipo de producto | ✓ |

### 9.3 Resumen

- Decisiones obligatorias en MDD: **125/125**
...
- Chat corporativo general, DMs, grupos y canales corporativos generales (D-073)
- Llamadas, videollamadas, pantalla, grabación, transcripción y capacidades síncronas relacionadas (D-074)
- Tickets, tareas, responsables, SLA, resolución, workflow y conclusiones formales (D-015, D-097)
- Calendarios (D-066)
- Mensajes efímeros (D-067)
- Moderación avanzada (D-068)
- Silenciar tema o contexto (D-056)
- Integraciones adicionales no identificadas (D-069)
...
| **2.0-local** | **2026-08-11** | **Pipeline Forge local: §0 patrones inmutables, §1–§8 desde EXPECTED-MDD, §9 trazabilidad generada, §10 changelog.** |
