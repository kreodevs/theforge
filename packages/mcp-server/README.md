...
**Spec-kit / implement:** `get_next_implementation_task(projectId)` → `GET /projects/:id/next-task` (siguiente tarea abierta con rutas y `[P]`). Repo handoff: API `GET /projects/:id/export/repo-handoff` o CLI `scripts/theforge-export.mjs`.
