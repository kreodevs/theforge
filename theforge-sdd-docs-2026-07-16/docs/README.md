...
| Necesitas… | Documento |
|------------|-------------|
| Release v1 — generación v2, Excalidraw híbrido, formateador Markdown, cola MDD | [THE-FORGE-V1-RELEASE.md](THE-FORGE-V1-RELEASE.md) |
| Sistema de plugins extensible | [PLUGINS.md](PLUGINS.md) |
| Brecha doc Fase 0 / estado sync corpus | [DOC-GAP-REPORT.md](DOC-GAP-REPORT.md) |
| Pipeline MDD lean, Quality Gate, tiers | [notebooklm/mdd-lean-migration.md](notebooklm/mdd-lean-migration.md) |
