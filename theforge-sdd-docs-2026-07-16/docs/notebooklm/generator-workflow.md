> ⚠️ **Obsoleto.** Este documento describe un flujo especulativo (Auditor con veto, Critic en grafo). **Implementación real:** `apps/api/src/modules/ai-analysis/README.md` — pipeline MDD lean + Quality Gate. Resumen: [THEFORGE-INDEX.md](THEFORGE-INDEX.md), [mdd-lean-migration.md](mdd-lean-migration.md).
