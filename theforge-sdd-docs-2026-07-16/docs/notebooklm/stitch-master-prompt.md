...
- **Nota implementación (2026-07):** el Workshop ya incluye **visor híbrido Mermaid/Excalidraw** en preview de documentos y **export spec-kit** (ZIP handoff). Los diagramas de flujo pueden editarse en Excalidraw y exportarse desde la pestaña de documentos; ver `ui-spec.md` y manual Workshop.
