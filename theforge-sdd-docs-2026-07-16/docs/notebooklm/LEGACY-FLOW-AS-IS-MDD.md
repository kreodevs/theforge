...
- **Gate `requireBrdTobeGate` retirado (jul 2026):** el flag persiste en Prisma pero ya no bloquea `generate-mdd` ni entregables; BRD/To-Be siguen siendo opcionales por etapa.
