...
| **SystemConfigCard** | Ajustes → **Sistema** (solo `super_admin`): edita configuración de plataforma (`GET/PATCH /admin/system-config`) — LLM, BullMQ, MCP, flags legacy y debug. Subpestañas por categoría (Integraciones, LLM, Colas, MCP, Legacy, Debug). |
