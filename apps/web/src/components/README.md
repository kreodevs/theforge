...
| **ExcalidrawDiagramBlock** | Mermaid → Excalidraw. `layout`: `inline` (altura acotada) o `fullscreen` (`h-full`, auto-fit al abrir). Rueda = zoom; chrome nativo oculto en vista (`ExcalidrawDiagramBlock.css`). |
