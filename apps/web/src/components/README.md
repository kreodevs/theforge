...
| **SystemConfigCard** | Ajustes → **Sistema** (solo `super_admin`): edita configuración de plataforma (`GET/PATCH /admin/system-config`) — LLM, BullMQ, MCP, Hermes, flags legacy y debug. |
