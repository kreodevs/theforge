...
import { WORKSHOP_PANEL_ACTION_PRIMARY } from "@/constants/workshopDocToolbar";
...
export const WORKSHOP_DOC_EMPTY_PRIMARY_BTN = cn(
  ...
  "w-full shadow-md shadow-[color-mix(in_oklch,var(--primary)_42%,transparent)] hover:shadow-lg hover:shadow-[color-mix(in_oklch,var(--primary)_48%,transparent)]",
);
  ...
  return (
    <div className="shrink-0 w-full min-w-0">
      <Button
        ...
        variant="default"
        size="default"
        className={cn(WORKSHOP_DOC_EMPTY_PRIMARY_BTN)}
        disabled={disabled}
        onClick={() => void onSave()}
      >
