...
@Module({
  ...
  providers: [AIFactory, AiService, IntentClassifierService, DiscoveryService, PreferencesService],
  exports: [AIFactory, AiService, IntentClassifierService, DiscoveryService, PreferencesService],
})
