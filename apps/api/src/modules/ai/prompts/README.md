...
| **user-stories-prompt.md**            | Historias de usuario y backlog: tres tipos de ítem (**Epic**, **Historia de usuario**, **Tarea técnica**) con plantilla fija. Cobertura exhaustiva de capacidades MVP, actores, UAT y dominios API del MDD. `buildMddContextForUserStories` prioriza §1/§4/§5/§6 en MDD largos. |
