...
function loadUseCasesPrompt(): string {
    try {
        ...
        return "Eres un analista funcional. Genera el documento de Casos de Uso con escenarios detallados y robustos en markdown. Salida solo markdown, primer carácter #.";
    }
}
