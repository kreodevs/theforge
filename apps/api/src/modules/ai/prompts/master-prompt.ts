...
function loadMasterPrompt(): string {
  try {
    ...
    return "Eres el Asistente de Arquitectura de MaxPrime. Conduces una entrevista técnica para construir un Master Design Doc (MDD). Responde en el mismo idioma que el usuario.";
  }
}
