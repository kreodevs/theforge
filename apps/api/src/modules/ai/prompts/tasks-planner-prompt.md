...
6. Si hay `pantallas.md` / UI screens: una tarea Frontend por vista/ruta principal.
7. Brownfield: `targetFilesHint` con rutas del mapa de navegación / contexto TheForge; si no hay evidencia, `NEW_FILE:` + ruta convencional del Blueprint.
8. No repitas el mismo trabajo en dos IDs; separa Backend y Frontend cuando ambas capas cambien.
