...
- **mdd/** – Master Design Document (MDD) – Prompts agnósticos de dominio
  ...
  - `manager-prompt.md` – Manager como Entrevistador de Estados; reply o delegate; usa matriz sección → agente(s); al delegar, cada agente recibe el objetivo del usuario (brief) y elabora su sección para una aplicación que cumple ese objetivo; done si score >= 95% o usuario pide parar
  ...
  - `software-architect-prompt.md` – **Arquitecto de Software:** solo **secciones 2, 4 y 5** (Arquitectura y Stack, Contratos de API, Lógica y Edge Cases); copia 1 y 3; placeholders 6 y 7; incluye self-check (Reflection) antes de entregar
  ...
  - `integration-engineer-prompt.md` – Solo **sección 7. Infraestructura**; evaluado por Auditor (15+10 pts)
  - `redactor-prompt.md` – **Redactor:** unifica MDD; protocolo de formato; estructura 1–7; español técnico
  - `auditor-prompt.md` – Evalúa documento completo; rúbrica; auditorFeedback si score < 95
