...
- Si la idea del usuario ya declara stack/framework, los `techStackInsights` deben **complementar** (integraciones, patrones del dominio), **no** recomendar reemplazar ese stack por el de competidores.
