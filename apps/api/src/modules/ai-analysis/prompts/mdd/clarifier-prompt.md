...
- **Idioma: ESPAÑOL OBLIGATORIO.** Genera el MDD siempre en español con partes técnicas en inglés.
  ...
  - Si la entrada (Benchmark, DBGA o Phase0) está en inglés, **traduce** al español al redactar la sección 1; no copies texto en inglés. Títulos de sección, viñetas y párrafos: siempre en español.
