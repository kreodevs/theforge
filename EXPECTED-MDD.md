...
**Fuente normativa:** `100-workspace-chat-domain-benchmark-gap-analysis.md` + `20-decision-log.md` + `20.1-decision-log-cierre.md`
**Sustituye a:** MDD v1, auditado en `101-auditoria-mdd-v1.md` (14 contradicciones, 21 capacidades ausentes)

> ### 🚨 REGLA DE TRAZABILIDAD (PROHIBIDO ELIMINAR)
> Toda regla, tabla, campo y endpoint de este documento cita el identificador de decisión
> que lo respalda (`D-xxx`). **Si algo no tiene identificador, no es una regla**: es
> propuesta de diseño o inferencia. Ningún agente posterior debe elevar una propuesta a
> requisito ni introducir capacidades sin D-ID.
...
| Grupo | Dónde se materializa en este MDD |
|---|---|
| D-002, D-004 | §1.1, §3.3 `contexts` |
| D-003, D-135 | §6.1; ausencia deliberada de endpoints de autenticación |
| D-006, D-124, D-025 | §3.4 `messages`; RN-04, RN-08 |
| D-010, D-141, D-142, D-143 | §2.4, §3.5 `outbox`, RN-08, RN-09, EC-21 |
| D-011 a D-014, D-045, D-081 | §3.3 `topics`; RN-02, RN-03 |
| D-016 a D-024 | §3.3 `context_memberships`; RN-04, RN-05 |
| D-027, D-060, D-136 a D-138 | §3.3; RN-10, EC-04, EC-05 |
| D-030, D-061 | §3.9 `read_states`, `notification_intents`; RN-19 |
| D-031, D-157 | §4.2 `/search`; RN-20, EC-16 |
| D-047, D-053, D-054, D-055, D-158 | §3.3, §3.4; §4.2 |
| D-057, D-080, D-115 | §3.4 `card_*`, §3.5 `business_events`, §4.3 |
| D-082 a D-085, D-149 a D-151 | §3.2 `platform_scopes`, §6.2, §6.3; RN-13, EC-11 a EC-13 |
| D-086, D-125 | §3.4 `attachments`, §6.5; RN-06, RN-07 |
| D-087, D-088 | §7.2, §8.1 |
| D-089 a D-092, D-131, D-132, D-147 | §3.6, §6.4; RN-14, RN-17, RN-18, EC-07, EC-22 |
| D-093, D-095, D-162 | §3 invariantes, §6.2, §7.7 |
| D-098, D-099, D-152, D-153 | §3.7, §6.6; RN-15, RN-16 |
| D-103 a D-108, D-127 | §3.8, §4.2; RN-11, RN-12, EC-14, EC-15 |
| D-109, D-110, D-161 | §3.9 `analytics_rollups`; RN-25 |
| D-111 a D-114 | §7.2, §7.3 |
| D-119 a D-121, D-154 | §3.9 `migration_jobs`; RN-22, RN-23, RN-24 |
| D-123, D-028, D-044 | §2.1, §8.1 |
| D-133 a D-135, D-145 | §3.1, §4.2, RN-01 |
| D-139, D-140 | §6.7 |
| D-144, D-146 | §1.3; ausencia deliberada de secuencia de entrega |
| D-148, D-155, D-156 | §1.6, §3.2; RN-05 |
| D-159, D-160 | §8.2; RN-21, EC-17 |
| D-163, D-164 | §1.4; §9.3 |
...
patrón Strangler, `ON DELETE CASCADE` sobre contenido, presencia ni confirmaciones de
lectura.

### 9.3 Límites declarados

1. **La fuente de descubrimiento no está versionada** (D-164): no ha podido verificarse que
   no existan decisiones anteriores contradictorias fuera del registro canónico.
2. **El servicio de llaves KMS/HSM no existe** (D-147, DEP-010, R-021). Toda la sección 6.4
   depende de una capacidad por construir o contratar.
3. **R-003 no tiene control preventivo** (D-142, D-143): el invariante de confiabilidad se
   exige por contrato, sin prueba obligatoria ni reacción automática.
4. **R-001 no tiene mitigación documental** (D-144, D-146): la única palanca es la
   desactivación de capacidades por aplicación (D-145).
5. Las tecnologías de §2.3 y §7 son **propuestas** (D-162) y pueden cambiar sin reabrir el
   alcance.
...
|---|---|---|
| 1.0 | — | Versión inicial generada desde BRD. Auditada en `101-auditoria-mdd-v1.md`: 14 contradicciones con decisiones confirmadas, 21 capacidades MVP ausentes, 6 entidades sin respaldo. |
| **2.0** | **2026-08-04** | **Regeneración completa desde `100`.** Eliminados multi-tenancy, `channels`, `conversations`, canal de mensajería externo, autenticación propia, orquestación de LLM y Strangler Fig. Incorporados adjuntos con cuarentena, reacciones, menciones y etiquetas, fijados, no leídos, dispositivos y custodia de llaves, procesadores confiables, motor de retención, legal hold, rich cards, búsqueda, alta de aplicación, ciclo de vida del contexto, membresía técnica de agente y activación modular. Trazabilidad de decisión en cada regla. |
